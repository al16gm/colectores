  ...
  return (
    <div className="space-y-8 py-6">
      <header>
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Galería Visitable</h1>
        <p className="text-slate-600 mt-2">Dimensionamiento de colector visitable con cuneta para aguas negras.</p>
      </header>

      <div className="grid lg:grid-cols-2 gap-8">
        <section className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
            <h2 className="text-lg font-bold text-slate-800">Caudales de Diseño</h2>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
            <h2 className="text-lg font-bold text-slate-800">Geometría de la Galería</h2>
        ...
        <section className="space-y-6">
            <div className={`p-6 rounded-2xl border-t-4 shadow-sm ${solution.isValid ? 'bg-white border-t-blue-500' : 'bg-white border-t-red-500'}`}>
                <h3 className="text-xs font-black text-slate-800 uppercase tracking-widest mb-6">Evaluación Técnica de Galería</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 flex flex-col items-center justify-center min-h-[300px]">
                <h4 className="text-xs font-bold text-slate-400 uppercase mb-4">Esquema Transversal</h4>
