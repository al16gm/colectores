  ...
  return (
    <div className="space-y-8 py-6">
      <header>
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Dimensionamiento Zonal</h1>
        <p className="text-slate-600 mt-2">Cálculo de red para dos sectores urbanos diferenciados que convergen en un punto.</p>
      </header>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <section className="space-y-6">
           ...
           <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
               <h3 className="font-bold text-slate-800 flex items-center gap-2">
                 ...
                 Dimensionamiento Colector Final
               </h3>
               <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1">
        ...
        <section className="space-y-6">
           <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl space-y-8">
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest border-b pb-4">Convergencia en Punto C</h3>
                ...
                <div className={`p-6 rounded-2xl border-t-4 shadow-sm bg-slate-50 ${solution.isValid ? 'border-t-green-500' : 'border-t-orange-500'}`}>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Verificación Hidráulica Final</h4>
                  <div className="grid grid-cols-2 gap-4">
